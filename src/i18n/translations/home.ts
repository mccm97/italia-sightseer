export const homeTranslations = {
  it: {
    ...
    why: {
      ...
      description2: 'Con WayWonder, ogni viaggio diventa un\'avventura su misura. La nostra piattaforma ti permette di scoprire le meraviglie di ogni città, dai monumenti più famosi ai luoghi meno conosciuti ma altrettanto affascinanti.'
    },
    features: {
  ...
  en: {
    ...
    why: {
      ...
      description2: 'With WayWonder, every journey becomes a tailored adventure. Our platform allows you to discover the wonders of each city, from famous monuments to lesser-known but equally fascinating places.'
    },
    features: {
      title: 'Features',
      planRoutes: {
